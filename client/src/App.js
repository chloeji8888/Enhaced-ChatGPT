...
function App() {
  ...
  async function handleSubmit(e){
    ...
    setInput("");
    //fetch response to the api combinging the chat log array of messages and sending it as a message to local host: 3001 as a post 
  ...
  <div className="App">
    <aside className = "sidemenu">
      <div className = "side-memu-button" onClick={clearChat}>
        <span>+</span>
        New Chat
      </div>
